...
def save_checkpoint(queue, args):
    ...
    def set_hf_layer_state(hf_model, layer_idx, layer_state):
        ...
        hf_layer.input_layernorm.weight.copy_(layer_state["input layernorm weight"])
        # hf_layer.input_layernorm.bias.copy_(layer_state["input norm bias"])
        hf_layer.post_attention_layernorm.weight.copy_(layer_state["post layernorm weight"])
    ...
    final_norm_msg = queue_get("final layernorm")
