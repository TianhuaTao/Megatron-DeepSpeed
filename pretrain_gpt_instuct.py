...
def model_provider(pre_process=True, post_process=True):
    ...
    if args.conversion_mode:
        # when conversion is True, the parallel group is not initialized
        dpg = None
        args.deepspeed_config_dict = None
    else:
    ...
    if args.conversion_mode:
        ...
        ds_config = args.deepspeed_config_dict if args.deepspeed else args.deepspeed_config
        ctx_manager = deepspeed.zero.Init(data_parallel_group=dpg,
